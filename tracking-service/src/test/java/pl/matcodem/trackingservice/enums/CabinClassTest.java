...
public class CabinClassTest {
    ...
    public void testGetDisplayName() {
        ...
        assertEquals("First Class", CabinClass.FIRST_CLASS.getDisplayName());
    }
    ...
    public void testGetNumberOfSeatsPerRow() {
        ...
        assertEquals(1, CabinClass.FIRST_CLASS.getNumberOfSeatsPerRow());
    }
    ...
    public void testHasInFlightEntertainment() {
        ...
        assertTrue(CabinClass.FIRST_CLASS.hasInFlightEntertainment());
    }
    ...
    public void testIncludesMeals() {
        ...
        assertTrue(CabinClass.FIRST_CLASS.includesMeals());
    }
    ...
    public void testGetAdditionalCost() {
        ...
        assertEquals(new BigDecimal("10000.00"), CabinClass.FIRST_CLASS.getAdditionalCost());
    }
    ...
    public void testCalculateUpgradeCost() {
        ...
        assertEquals(new BigDecimal("20000.00"), CabinClass.FIRST_CLASS.calculateUpgradeCost(2));
    }
    ...
    public void testGetClassByDisplayName() {
        ...
        assertEquals(CabinClass.FIRST_CLASS, CabinClass.getClassByDisplayName("First Class"));
    }
    ...
    public void testIsLuxurious() {
        ...
        assertTrue(CabinClass.FIRST_CLASS.isLuxurious());
    }
    ...
    public void testIsEconomical() {
        ...
        assertFalse(CabinClass.FIRST_CLASS.isEconomical());
    }
}