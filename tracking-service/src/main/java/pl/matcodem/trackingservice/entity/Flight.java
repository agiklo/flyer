...
@NamedQuery(name = FlightQueries.FIND_FLIGHTS_BY_DEPARTURE_AND_ARRIVAL_AIRPORTS_AND_DATE, query = FlightQueries.SQL_FIND_FLIGHTS_BY_DEPARTURE_AND_ARRIVAL_AIRPORTS_AND_DATE)
